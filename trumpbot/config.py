...
# Placeable mention families get the first discovery slots every tick.
HOT_FAMILIES = ("POLITICIAN", "NEWS_SHOW", "ENTERTAINMENT")
HOT_DISCOVERY_SECONDS = 5
DISCOVERY_MAX_HOT_PER_TICK = 6
DISCOVERY_MAX_COLD_PER_TICK = 2

CUTOFF_LISTED_CT = "2026-09-01 00:00:00"

FIRST_LIST_GRACE_SECONDS = 300
